...
# Train and evaluate a separate SVR model for each target parameter
for target in target_features:
    ...
    grid_search = GridSearchCV(estimator=svr, param_grid=param_grid, cv=3, verbose=1, n_jobs=-1, error_score='raise')
    ...
    try:
        ...
        best_svr_model = grid_result.best_estimator_
        ...
        print(f"Failed to train SVR for {target}: {e}")
